...
export default function AppShell(){
 ...
 const nav=[['/','dashboard',null],['/organizations','organizations','organizations.view'],['/clients','clients','clients.view'],['/contracts','contracts','contracts.view'],['/sites','sites','sites.view'],['/locations','locations','locations.view'],['/asset-categories','categories','assets.view'],['/assets','assets','assets.view'],['/corrective','corrective','corrective.view'],['/users','usersRoles','users.view']]
 return <div className="app-shell"><aside className="sidebar"><div className="brand"><div className="brand-mark">BF</div><div><h2>{t('appName')}</h2><small>Sprint 4 — Corrective</small></div></div>
